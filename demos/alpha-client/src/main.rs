//! alpha-client — live GlassVein demo runtime client.
//!
...
async fn main() -> Result<()> {
    ...
    println!("==============================================================");
    println!("  alpha-client — live demo runtime client");
    ...
    let profile = DemoProfile {
        label: "alpha-client",
        node_id: "alpha-client",
        session: "session-alpha",
        state: osgp::SessionState::Running,
        title: "Code Review: PR #42",
        summary: "Reviewing surface crate observer/control split",
        metadata: json!({"model":"mimo-v2.5-pro","task":"code-review","files_changed":7,"lines_added":340,"lines_removed":12,"language":"rust"}),
    };
...
fn parse_args() -> Result<Args> {
    let mut node_id = "alpha-client".to_string();
...
fn print_help() {
    println!("Usage: alpha-client [OPTIONS]");
    println!();
    println!("Options:");
    println!("  --node-id <id>         Client node ID (default: alpha-client)");
