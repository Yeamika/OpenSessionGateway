...
import type { CurrentClientInfo as SharedCurrentClientInfo } from "protocllibrary/ws-contract/CurrentClient.js";
...
export function applyEventToCurrentClientInfo(
  ...
  const eventSessionID = typeof props.sessionID === "string" ? props.sessionID.trim() : "";
